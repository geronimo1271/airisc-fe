<template>
  <footer ref="footer" class="border-t border-solid border-grey-200 bg-white">
    <section
      class="items-center justify-between px-4 py-10 lg:flex lg:px-7 lg:py-11"
    >
      ...
      <div class="mt-5 items-center lg:order-first lg:mt-0 lg:flex">
        <ul class="flex items-center justify-center">
          ...
          >
            <NuxtLink
              ...
              class="text-xs-1 text-blue-500 md:text-m-1"
            >
              Privacy Policy
            </NuxtLink>
          </li>
        ...
        <div class="mt-6 text-center lg:order-first lg:mr-12 lg:mt-0">
          <a
            href="https://endo-ern.eu/patient-organisation/arfsag-associazione-refionale-famiglie-sindrome-adreno-genitale/"
            target="_blank"
            class="text-s-1 font-bold text-blue-500 md:text-l-1"
          >
            <img
