...
import type { ILivignoCardPage } from "~/types/api/livigno-card-page";
import {
...
const { data: pageData } = await useAsyncData("livigno-card-page", () => {
  return findOne<ILivignoCardPage>("livigno-card-page", undefined, {
